...
system("cls");
    ...
    printf("\n\t\tPassword terakhir yang anda masukkan : %s \n",pass2);
...
system("cls");
    ...
    while(a=='y'||a=='Y'){
        ...
        if(kode==1){
            obat = 5000 ;
            printf("\t\t\t |SANMOL TABLET = Rp %d              |\n",obat);
        }
        else if(kode==2){
            obat = 7000;
            printf("\t\t\t |SANMOL SYRUP = Rp %d              |\n",obat);
        }
        else if(kode==3){
            obat = 12000;
            printf("\n\t\t\t |METFORMIN = Rp %d                 |\n",obat);
...
system("cls");
    ...
    scanf("%s",&gd2);
        ...
        printf("\n\t\t\t\TTidak ada manusia dengan golongan darah ituu!!\n\n");
        goto ulangi;
        }
    printf("\t\t\tDomisili                  : ");
    scanf("%s",&al2);
